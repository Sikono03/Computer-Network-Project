...
__Router1 Sub-interfaces_                      Trunk Links:
...
* __ping_ and __traceroute_ between VLANs to confirm inter-VLAN routing.
* __ipconfig/all_ on PCs to confirm DHCP-assigned addresses and correct gateway.
* __nslookup_ to confirm DNS resolution.
* Browser test to Web Server IP/hostname to confirm HTTP access.
* __show vlan brief_ and __show interfaces trunk_ on switches to confirm VLAN/trunk config.
